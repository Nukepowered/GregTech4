...
public class CutterRecipeHandler extends GT_RecipeHandler {
	...
	public class CachedCutterRecipe extends CachedGT_Recipe {
		...
		public CachedCutterRecipe(Recipe aRecipe) {
	...
	public void drawExtras(int recipe) {
		...
		drawText(30, 80, I18n.format("nei.extras.eu_total", GT_Utility.parseNumberToString(time * ((CachedCutterRecipe)arecipes.get(recipe)).mEUt)), 0xFF000000, false);
		drawText(30, 90, I18n.format("nei.extras.time", GT_Utility.parseNumberToString(time / 20.0D)), 0xFF000000, false);
		drawText(30, 100, I18n.format("nei.extras.eut", GT_Utility.parseNumberToString(((CachedCutterRecipe)arecipes.get(recipe)).mEUt)), 0xFF000000, false);
	}
}