...
public class GT_MetaTileEntity_Electrolyzer extends GT_MetaTileEntity_BasicTank {
    ...
    private boolean checkRecipe() {
    	GT_Recipe tRecipe = GT_Recipe.findEqualRecipe(false, false, GT_Recipe.sElectrolyzerRecipes, mInventory[0], mInventory[1]);
    	if (tRecipe != null) {
    	...
    	if (mFluid != null) {
    		...
    		if (tStack != null && tFluid != null) {
    			...
    			tRecipe = GT_Recipe.findEqualRecipe(false, false, GT_Recipe.sElectrolyzerRecipes, tStack, mInventory[1]);
		    	if (tRecipe != null) {
