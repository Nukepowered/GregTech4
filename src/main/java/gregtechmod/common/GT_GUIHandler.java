...
//		NetworkRegistry.instance().registerGuiHandler(GregTech_API.gregtechmod, this);
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (ID == 131) return new GT_GUIContainer_BasicMachine_Macerator	(player.inventory, (IGregTechTileEntity)tTileEntity, "Automatic Macerator", "Macerator.png");
        if (ID == 132) return new GT_GUIContainer_BasicMachine_Extractor	(player.inventory, (IGregTechTileEntity)tTileEntity, "Automatic Extractor", "Extractor.png");
        if (ID == 133) return new GT_GUIContainer_BasicMachine_Compressor	(player.inventory, (IGregTechTileEntity)tTileEntity, "Automatic Compressor", "Compressor.png");
        if (ID == 134) return new GT_GUIContainer_BasicMachine				(player.inventory, (IGregTechTileEntity)tTileEntity, "Automatic Recycler", "Recycler.png");
        if (ID == 135) return new GT_GUIContainer_BasicMachine_E_Furnace	(player.inventory, (IGregTechTileEntity)tTileEntity, "Automatic E-Furnace", "E_Furnace.png");
        if (ID == 136) return new GT_GUIContainer_BasicMachine_Wiremill		(player.inventory, (IGregTechTileEntity)tTileEntity, "Automatic Wiremill", "Wiremill.png");
        if (ID == 137) return new GT_GUIContainer_BasicMachine_AlloySmelter	(player.inventory, (IGregTechTileEntity)tTileEntity, "Alloy Smelter", "E_Furnace.png");
        if (ID == 138) return new GT_GUIContainer_BasicMachine_Canner		(player.inventory, (IGregTechTileEntity)tTileEntity, "Automatic Canning Machine", "Canner.png");
        if (ID == 139) return new GT_GUIContainer_ElectricTypeSorter		(player.inventory, (IGregTechTileEntity)tTileEntity);
        if (ID == 140) return new GT_GUIContainer_BasicMachine_Bender		(player.inventory, (IGregTechTileEntity)tTileEntity, "Plate Bending Machine", "Bender.png");
        if (ID == 141) return new GT_GUIContainer_BasicMachine_Assembler	(player.inventory, (IGregTechTileEntity)tTileEntity, "Assembling Machine", "Assembler.png");
        if (ID == 142) return new GUI_Printer								(player.inventory, (IGregTechTileEntity)tTileEntity, "Printing Factory", "Printer.png");
        ...
        if (ID == 156) return new GT_GUIContainer_MultiMachine				(player.inventory, (IGregTechTileEntity)tTileEntity, "Gas Turbine", "MultiblockDisplay.png");
        if (ID == 157) return new GT_GUIContainer_MultiMachine				(player.inventory, (IGregTechTileEntity)tTileEntity, "Steam Turbine", "MultiblockDisplay.png");
        if (ID == 158) return new GT_GUIContainer_MultiMachine				(player.inventory, (IGregTechTileEntity)tTileEntity, "Thermal Boiler", "MultiblockDisplay.png");
        if (ID == 159) return new GT_GUIContainer_BasicMachine_Lathe		(player.inventory, (IGregTechTileEntity)tTileEntity, "Lathe", "Lathe.png");
        ...
        if (ID == 162) return new GT_GUIContainer_BasicMachine_Cutter		(player.inventory, (IGregTechTileEntity)tTileEntity, "Plate Cutting Machine", "Cutter.png");
        if (ID == 163) return new GT_GUIContainer_BronzeBoiler				(player.inventory, (IGregTechTileEntity)tTileEntity);
        if (ID == 164) return new GT_GUIContainer_BasicMachine				(player.inventory, (IGregTechTileEntity)tTileEntity, "Sturdy Grinder", "BronzeMacerator.png");
        if (ID == 165) return new GT_GUIContainer_BasicMachine_E_Furnace	(player.inventory, (IGregTechTileEntity)tTileEntity, "Steam Furnace", "BronzeFurnace.png");
        if (ID == 166) return new GT_GUIContainer_BasicMachine_AlloySmelter	(player.inventory, (IGregTechTileEntity)tTileEntity, "Steam Smelter", "BronzeFurnace.png");
        if (ID == 167) return new GT_GUIContainer_BasicMachine				(player.inventory, (IGregTechTileEntity)tTileEntity, "Steam Forge Hammer", "BronzeHammer.png", (byte)6, (byte)3);
        if (ID == 168) return new GT_GUIContainer_BasicMachine_Compressor	(player.inventory, (IGregTechTileEntity)tTileEntity, "Steam Compressor", "BronzeCompressor.png");
        if (ID == 169) return new GT_GUIContainer_BasicMachine_Extractor	(player.inventory, (IGregTechTileEntity)tTileEntity, "Steam Extractor", "BronzeExtractor.png");
        ...
        if (ID == 172) return new GT_GUIContainer_BasicMachine_E_Furnace	(player.inventory, (IGregTechTileEntity)tTileEntity, "High Pressure Steam Furnace", "SteelFurnace.png");
        ...
        if (ID == 180) return new GT_GUIContainer_BasicMachine				(player.inventory, (IGregTechTileEntity)tTileEntity, "Scanner", "Scanner.png");
        if (ID == 181) return new GT_GUIContainer_BasicMachine_Extruder		(player.inventory, (IGregTechTileEntity)tTileEntity, "Extruder", "Extruder.png");
