...
public class GT_SolderingMetal_Item extends GT_Tool_Item {
	public GT_SolderingMetal_Item(Item aItem, String aUnlocalized, String aEnglish, int aMaxDamage, int aEntityDamage) {
		super(aItem, aUnlocalized, aEnglish, "Used in conjunction with Soldering Tools", aMaxDamage, aEntityDamage, false);
