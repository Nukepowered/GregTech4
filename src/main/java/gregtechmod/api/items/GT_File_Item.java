...
public class GT_File_Item extends GT_Tool_Item {
	public GT_File_Item(Item aItem, String aUnlocalized, String aEnglish, int aMaxDamage, int aEntityDamage) {
		super(aItem, aUnlocalized, aEnglish, "For sharpening or rounding Edges", aMaxDamage, aEntityDamage, true);
