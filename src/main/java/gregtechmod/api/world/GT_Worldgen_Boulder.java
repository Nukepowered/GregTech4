...
public class GT_Worldgen_Boulder extends GT_Worldgen_Ore {
	public GT_Worldgen_Boulder(String aName, boolean aDefault, Block block, int aBlockMeta, int aDimensionType, int aAmount, int aSize, int aProbability, int aMinY, int aMaxY, Collection<String> aBiomeList, boolean aAllowToGenerateinVoid) {
		super(aName, aDefault, block, aBlockMeta, aDimensionType, aAmount, aSize, aProbability, aMinY, aMaxY, aBiomeList, aAllowToGenerateinVoid);
	}
			                        ...
			                        if (var39 * var39 + var42 * var42 < 1.0D) {
			                            for (int var44 = var34; var44 <= var37; ++var44) {
			                                ...
			                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && ((mAllowToGenerateinVoid&&aWorld.getBlock(var38, var41, var44) == Blocks.air) || (block != null && !(block instanceof BlockContainer)))) {
			                                    aWorld.setBlock(var38, var41, var44, block, mBlockMeta, 0);
			                                }
			                            }
			                        }
			                    }
