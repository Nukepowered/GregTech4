...
public class BaseMetaTileEntityIC extends BaseMetaTileEntity implements IIC2TileEntity {
	...
	public double injectEnergy(ForgeDirection aDirection, double aAmount, double voltage) {return injectEnergyUnits((byte)aDirection.ordinal(), (int)aAmount, 1)?0:aAmount;}
