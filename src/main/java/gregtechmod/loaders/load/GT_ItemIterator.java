...
public class GT_ItemIterator implements Runnable {
	...
	public void run() {
		        ...
		        GregTech_API.sRecipeAdder.addCannerRecipe(new ItemStack(Items.rotten_flesh, 1, 32767), GT_Items.IC2_Food_Can_Empty.get(2L), GT_Items.IC2_Food_Can_Spoiled.get(2L), null, 200, 1);
		        GregTech_API.sRecipeAdder.addCannerRecipe(new ItemStack(Items.spider_eye, 1, 32767), GT_Items.IC2_Food_Can_Empty.get(1L), GT_Items.IC2_Food_Can_Spoiled.get(1L), null, 100, 1);
		        GregTech_API.sRecipeAdder.addCannerRecipe(new ItemStack(Items.poisonous_potato, 1, 32767), GT_Items.IC2_Food_Can_Empty.get(1L), GT_Items.IC2_Food_Can_Spoiled.get(1L), null, 100, 1);
		        GregTech_API.sRecipeAdder.addCannerRecipe(new ItemStack(Items.cake, 1, 32767), GT_Items.IC2_Food_Can_Empty.get(6L), GT_Items.IC2_Food_Can_Filled.get(6L), null, 600, 1);
		        GregTech_API.sRecipeAdder.addCannerRecipe(new ItemStack(Blocks.cake, 1, 32767), GT_Items.IC2_Food_Can_Empty.get(6L), GT_Items.IC2_Food_Can_Filled.get(6L), null, 600, 1);
		        GregTech_API.sRecipeAdder.addCannerRecipe(new ItemStack(Items.bowl, 1, 32767), GT_Items.IC2_Food_Can_Empty.get(3L), GT_Items.IC2_Food_Can_Filled.get(3L), new ItemStack(Items.bowl, 1), 300, 1);
		            ...
		            if (tItem != null && (tName = tItem.getUnlocalizedName()) != null) {
		                ...
		                if (tItem instanceof ItemBlock) {
		                    try {
		                        ...
		                        System.err.println("ATTEMPTED BLOCK ID: " + ((ItemBlock)tItem).getUnlocalizedName());
		                        System.err.println("");
		                        e2.printStackTrace();
		                        System.err.println("");
		                ...
		                if (tItem instanceof ItemFood && tItem != GT_Items.IC2_Food_Can_Filled.getItem() && tItem != GT_Items.IC2_Food_Can_Spoiled.getItem()) {
		                    final int tFoodValue = (int)Math.ceil(func_150905_g(new ItemStack(tItem)) / 2.0D);
		                    if (tFoodValue > 0) {
		                        GregTech_API.sRecipeAdder.addCannerRecipe(new ItemStack(tItem, 1, 32767), GT_Items.IC2_Food_Can_Empty.get(tFoodValue), GT_Items.IC2_Food_Can_Filled.get(tFoodValue), GT_Utility.getContainerItem(new ItemStack(tItem, 1, 0)), tFoodValue * 100, 1);
		                    }
		                }
		                ...
		                if (tName.equals("item.ItemSensorLocationCard") || tName.equals("item.ItemEnergySensorLocationCard") || tName.equals("item.ItemEnergyArrayLocationCard") || tName.equals("item.ItemTextCard")) {
		                    GregTech_API.sRecipeAdder.addAssemblerRecipe(new ItemStack(tItem, 1, 32767), null, GT_Items.Circuit_Basic.get(2L), 200, 32);
		                }
		                if (tName.equals("item.ItemTimeCard")) {
		                    GregTech_API.sRecipeAdder.addAssemblerRecipe(new ItemStack(tItem, 1, 32767), null, GT_Items.Circuit_Basic.get(1L), 100, 32);
		                }
		        ...
		        if (tCharmL != null) {
		            GregTech_API.sRecipeAdder.addAssemblerRecipe(GT_Utility.copyAmount(4L, tCharmL), null, GT_Utility.copyAmount(1L, tCharmLL), 800, 2);
		        }
		        if (tCharmI != null) {
		            GregTech_API.sRecipeAdder.addAssemblerRecipe(GT_Utility.copyAmount(4L, tCharmI), null, GT_Utility.copyAmount(1L, tCharmII), 800, 2);
		        }
		        if (tCharmII != null) {
		            GregTech_API.sRecipeAdder.addAssemblerRecipe(GT_Utility.copyAmount(4L, tCharmII), null, GT_Utility.copyAmount(1L, tCharmIII), 800, 2);
		        }
		    }	
//		Item tItem;
//		String tName;
...
//				}
//				if (tName.equals("tile.enderchest")) {
//					GT_OreDictUnificator.registerOre("craftingEnderChest",
...
//				}
//				if (tName.equals("item.minotaurAxe")) {
//					GT_ModHandler.addPulverisationRecipe(new ItemStack(tItem, 1, 0),
//							GT_OreDictUnificator.get("dustDiamond", 1), GT_OreDictUnificator.get("dustWood", 1), 50,
//							false);
//				}
//
//				if (tName.equals("item.bucketFuel")) {
//					GT_ModHandler
//							.addCraftingRecipe(
//									GT_ModHandler.getRecipeOutput(new ItemStack[] { null,
//											GT_OreDictUnificator.get(OrePrefixes.ingot, (Object) Materials.Steel, 1L),
//											null,
//											GT_OreDictUnificator.get(OrePrefixes.ingot, (Object) Materials.Steel, 1L),
...
//											GT_OreDictUnificator.get(OrePrefixes.ingot, (Object) Materials.Steel,
//													1L) }),
//									new Object[] { " S ", "SCS", "SLS", Character.valueOf('S'),
//											OrePrefixes.plate.get(Materials.Steel), Character.valueOf('C'),
//											OrePrefixes.circuit.get(Materials.Basic), Character.valueOf('L'),
//											OrePrefixes.cell.get(Materials.Lithium) });
//				}
//
//				if (tName.equals("item.drawplateDiamond")) {
//					GT_OreDictUnificator.registerOre(GT_ToolDictNames.craftingToolDrawplate,
